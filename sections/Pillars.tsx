...
const pillars = [
    {
      ...
      description: "Fostering a culture of continuous learning and exchange of ideas within our community.",
      icon: Share2
    },
    {
      title: "Innovation and Application",
      description: "Encouraging creative problem-solving and practical implementation of data science concepts.",
      icon: Lightbulb
    },
    {
      title: "Collaboration and Networking",
      description: "Building strong connections among members and industry professionals to create opportunities.",
      icon: Users
    },
    {
      title: "Ethics and Impact",
      description: "Promoting responsible use of data science to create positive change in society.",
      icon: Scale
    }
  ];
