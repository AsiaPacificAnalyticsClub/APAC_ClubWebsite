...
const Merch = () => {
  const preOrderLink =
    "https://docs.google.com/forms/d/e/1FAIpQLSeJJfvmG8Tq73qe9Kb6GZDbMAV_BG6KWKrb9DS4LfCMH1BgAg/viewform?usp=sf_link";
    ...
    <section className="container mx-auto px-4 py-12">
      ...
      >
        ...
        <p className="mt-4 text-gray-600 max-w-2xl mx-auto">
          Show your support with our exclusive merchandise collection. Pre-order
          now and be part of our community!
        </p>
      </motion.div>
      ...
      >
        <p className="text-sm text-gray-500">
          * Pre-orders are processed through Google Forms. Delivery times may
          vary.
        </p>
      </motion.div>
    </section>
